...
class _EditorScreenState extends State<EditorScreen> {
  ...
  void initState() {
    ...
    _locationController = TextEditingController(text: props?.location ?? '')
      ..addListener(_checkForChanges);
    _urlController = TextEditingController(text: props?.url?.toString() ?? '')
      ..addListener(_checkForChanges);
    _selectedType = props?.type ?? 'misc';
  ...
  void _checkForChanges() {
    final original = widget.selectedFeature?.properties;
    ...
    final hasChanged = isDifferent(_nameController.text, original?.name) ||
        ...
        isDifferent(_locationController.text, original?.location) ||
        isDifferent(_urlController.text, original?.url?.toString()) ||
  ...
  Widget build(BuildContext context) {
    ...
    String submittedMessage =
        'Thanks for submitting your changes! We will review them shortly.';
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      validator: (value) {
                                        if (value == null ||
                                            value.trim().isEmpty) return null;
